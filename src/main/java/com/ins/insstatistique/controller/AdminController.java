...
public class AdminController {
    ...
    public ResponseEntity<Investigateur> updateInvestigateur(@PathVariable Long id, @RequestBody Investigateur investigateur) {
        return ResponseEntity.ok(adminService.updateInvestigateur(id, investigateur));
    }
